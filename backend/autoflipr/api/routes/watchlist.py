...
def get_watchlist(current_user: CurrentUser, db: DBSession):
    rows = (
...
def add_to_watchlist(listing_id: int, current_user: CurrentUser, db: DBSession):
...
def remove_from_watchlist(listing_id: int, current_user: CurrentUser, db: DBSession):
...
def sync_watchlist(body: SyncRequest, current_user: CurrentUser, db: DBSession):
